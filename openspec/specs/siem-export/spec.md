# siem-export Specification

## Purpose

Define the SIEM export pipeline that normalizes events from AuditLog, ToolDecision, and SecurityFinding into SecurityEvent, formats them via pluggable exporters (webhook, syslog, OCSF), and manages batch collection with configurable filtering.
