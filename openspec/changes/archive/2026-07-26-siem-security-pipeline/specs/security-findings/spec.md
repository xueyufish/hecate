...
The system SHALL automatically delete findings older than the configured retention period (`SECURITY_FINDING_RETENTION_DAYS`, default 90 days — longer than ToolDecision retention because findings are lower volume and higher investigative value).
