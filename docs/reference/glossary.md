...
- **Extension Point** — an abstract interface (ABC) in the engine layer that lets you customize execution. Hecate defines 11 core extension points plus 6 optional SPI methods on `EnginePort`. See [Extension Points Reference](extension-points.md).
