...
- **[Performance Baselines](performance-baselines.md)** — measurement methodology, latency breakdown (LLM dominates), component bottlenecks, and an honest template for collecting real numbers. Use this to size your deployment and verify tuning.
