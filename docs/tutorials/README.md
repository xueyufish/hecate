...
4. **[Multi-Agent Orchestration](04-multi-agent.md)** *(30 min)* — build workflows with six collaboration patterns (Hierarchical, Handoff, Pipeline, Broadcast, Negotiation, Debate).
