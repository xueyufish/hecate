...
Engine Parity (1.3.21): Declarative Interrupts (①) → Time-Travel Resume (②) → Dynamic Fan-out (③) → Deep Research (5.11) parallel collection; ② feeds What-If Checkpoint Branching (6.26 E5) + executable 8.20 replay
