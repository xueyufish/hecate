...
| 7.3a / 7.3b / 7.3c | Evaluation Suite remainder（7.3 follow-ups）— 7.3 三个子特性：publish 阻断开关（仅确定性评估器，默认关） / 命名 dataset 版本管理（版本对象 + checkout/diff） / known-bad 豁免标注。同批兄弟 7.2d（trace 回流）✅ 2026-09-12、7.4/7.4a（人工标注 + calibration）✅ 2026-09-12 | 7.1 / 7.2 / 7.2a ✅ / 7.2c ✅ / 7.2d ✅ / 7.2e ✅ / 7.3 ✅ / 7.4 ✅ | M + S + S |底座 ✅; AgentArts 评估页是产品完成度最高的面, 报告仪表盘已由 7.2e 补齐, 标注已由 7.4 补齐, 回流已由 7.2d 补齐; 调研结论（2026-09 竞品对比）已沉淀于各自 change 的 design |
