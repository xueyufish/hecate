...
**Index last reconciled recently**: all many L2 design documents listed below are present in this directory; status attribution reflects the release-scope reclassification (P3 closed 87/87, 48 items deferred to P4, 11.4 / 11.5 / 11.9-Discord/Telegram moved to P5 per [roadmap.md](../features/roadmap.md)). Engine-extension count is **many (multiple Core + SPI)** per [ADR-016](adr/016-platform-spi-architecture.md).
