...
| **Engine-level extensibility** | ✅ 11 core + 4 SPI | Plugins | Decorators | Limited | Limited | Bring your framework | Nodes |
...
**Hecate's advantage**: Full source code, 11 core + 4 SPI extension points at the engine layer. Dify's extension model is via Marketplace plugins, not engine-level SPI.
...
> *"Tools like LangGraph and Dify are great at prototyping agents, but Hecate is the platform that lets you **ship** them — self-hosted, multi-tenant, OpenAI-compatible, with the protocols (MCP, A2A) wired in and the engine (11 core + 4 SPI) open for extension."*
...
| **Visual canvas** | ✅ | ✅ | ❌ | ✅ |
| **Engine-level SPI** | Limited | Limited | Limited | ✅ 11 core + 4 SPI |
