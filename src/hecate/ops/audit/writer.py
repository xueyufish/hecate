...
if TYPE_CHECKING:
    from hecate.ops.audit.policy import FindingEngine
...
class AuditBatchWriter:
    ...
    def _emit_audit_to_siem(self, event: AuditEvent) -> None:
        ...
        with contextlib.suppress(Exception):
            ...
            from hecate.ops.siem.event import from_audit_log
    ...
    async def _evaluate_policies(self, batch: list[AuditEvent]) -> None:
        ...
        from hecate.ops.audit.policy import DetectionContext
        ...
        for event in batch:
            ...
            for finding in violations:
                ...
                with contextlib.suppress(Exception):
                    from hecate.ops.siem.collector import emit_to_siem
                    from hecate.ops.siem.event import from_security_finding
