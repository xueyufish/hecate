...
The factory lives in the engine layer so it does not depend on services.
"""
...
from hecate.engine.middleware import Chain, Phase
from hecate.engine.middleware_adapters import (
    adapt_post_llm_hook,
