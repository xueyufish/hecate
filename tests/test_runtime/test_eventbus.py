...
from hecate.runtime.eventbus import (
    CollaborationEvent,
...
class TestPregelRuntimeEventBusIntegration:
    ...
    async def test_event_bus_in_context(self) -> None:
        from hecate.runtime.channel import ChannelDef, ChannelType
        from hecate.runtime.checkpoint import InMemoryCheckpointStore
        from hecate.runtime.pregel import PregelRuntime
        from hecate.runtime.types import CompiledGraph, Edge, NodeConfig, NodeType
